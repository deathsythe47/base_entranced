...
stringID_table_t bgSiegeClassFlagNames[] =
{
	...
	ENUM2STRING(CFL_BIGSMALLSHIELD),
	ENUM2STRING(CFL_EXPLOSIVESENTRY),
	ENUM2STRING(CFL_TAKESPRENERFDISRUPTDMG),
	ENUM2STRING(CFL_NODISRUPTFALLOFF),
	ENUM2STRING(CFL_ARMORTANK),
	{"", -1}
};
