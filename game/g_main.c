...
vmCvar_t    g_fixKorriDelay;
vmCvar_t    g_fixKorriReturns;
...
vmCvar_t	g_reduceJetpackToggleTime;
...
static cvarTable_t		gameCvarTable[] = {
	...
	{ &g_saberLocking, "g_saberLocking", "1", CVAR_ARCHIVE, 0, qtrue  },
	...
	{ &g_enableTrollItems, "g_enableTrollItems", "0", CVAR_ARCHIVE, 0, qtrue },
	...
	{ &g_fixKorriDelay, "g_fixKorriDelay", "1", CVAR_ARCHIVE | CVAR_LATCH, 0, qtrue },
	{ &g_fixKorriReturns, "g_fixKorriReturns", "1", CVAR_ARCHIVE | CVAR_LATCH, 0, qtrue },
	...
	{ &g_reduceJetpackToggleTime, "g_reduceJetpackToggleTime", "1", CVAR_ARCHIVE, 0, qtrue },
...
static void InitializeMapName(void) {
	...
	} else if (stristr(level.mapname, "siege_korriban2")) {
		level.siegeMap = SIEGEMAP_KORRIBAN;
		level.isKorri2 = qtrue;
		level.numSiegeObjectivesOnMapCombined = 4;
...
void G_RunFrame( int levelTime ) {
	...
	const qboolean wasRestartedNow = (level.wasRestarted && level.isLivePug != ISLIVEPUG_NO && numRed >= 2 && numBlue >= 2);
